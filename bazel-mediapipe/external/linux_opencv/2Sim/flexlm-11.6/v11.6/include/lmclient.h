...
lm_extern int lc_flexinit(struct flexinit_property_handle *);
lm_extern int lc_flexinit_cleanup(struct flexinit_property_handle *);
lm_extern int lc_flexinit_property_handle_create(struct flexinit_property_handle **);
lm_extern int lc_flexinit_property_handle_free(struct flexinit_property_handle *);
lm_extern int lc_flexinit_property_handle_set(struct flexinit_property_handle *,
			FLEXINIT_PROPERTY_TYPE, FLEXINIT_VALUE_TYPE);
lm_extern int lc_flexinit_property_handle_get(struct flexinit_property_handle *,
			FLEXINIT_PROPERTY_TYPE, FLEXINIT_VALUE_TYPE *);
